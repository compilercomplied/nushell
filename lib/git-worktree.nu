...
export def git-feature-worktree-path [branch_name: string] {
...
export def git-update-main-worktree [main_branch: string] {
    let primary_path = (git-primary-worktree-path)
...
export def git-create-feature-worktree [branch_name: string, main_branch: string] {
    let primary_path = (git-primary-worktree-path)
...
export def git-open-feature-worktree [branch_name: string, main_branch: string] {
    let primary_path = (git-primary-worktree-path)
    let worktree_path = (git-feature-worktree-path $branch_name)
    if ($worktree_path | path exists) {
